  ...
  get() {
    if (this.taskArray.length == 0) {
      ...
      const box2 = new tasksBox(
        ...
        'admin',
        false,
        'Aenean massa. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis...'
      );
      this.idAutoIncrement += 1;
      const box3 = new tasksBox(
        this.idAutoIncrement,
        'Create UX test',
        new Date(),
        'In progress',
